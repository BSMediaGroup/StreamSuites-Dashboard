...
test("economy styling includes compact identity rows and currency/denomination treatments", () => {
  ...
  assert.match(css, /\.ss-economy-item-create-grid\s*\{[\s\S]*grid-template-columns:\s*minmax\(260px,\s*0\.92fr\) minmax\(250px,\s*0\.62fr\) minmax\(280px,\s*0\.72fr\) minmax\(320px,\s*0\.9fr\)/);
  ...
  assert.match(css, /\.ss-economy-item-editor\s*\{[\s\S]*grid-template-columns:\s*minmax\(280px,\s*0\.75fr\) minmax\(250px,\s*0\.6fr\) minmax\(280px,\s*0\.75fr\) minmax\(330px,\s*1fr\)/);
  assert.match(css, /\.ss-economy-card-grid\s*\{[\s\S]*grid-template-columns:\s*repeat\(auto-fit,\s*minmax\(min\(100%,\s*360px\),\s*1fr\)\)/);
