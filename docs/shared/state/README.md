...
* `quotas.json` – (optional) Exported quota snapshot for read-only visualization.
* `runtime_snapshot.json` – (optional) Telemetry overlay exposed by the runtime for overview panels.
