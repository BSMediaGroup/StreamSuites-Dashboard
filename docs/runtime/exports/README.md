...
- `version-registry.json` is the deterministic public-safe projection of the Runtime/Auth registry. It exposes the system semantic version, current ecosystem revision/build, registered public components, initialized public product baselines, and public-safe latest build/deployment/publication summaries. It excludes reporter workflow policy, OIDC claims, tokens, database paths, full internal metadata, and private component mappings.
