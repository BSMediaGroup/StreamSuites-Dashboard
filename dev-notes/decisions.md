...
- Platform sequencing: Twitch foundation first, YouTube hydration next, Rumble alignment leveraging the new SSE chat stream (`https://web7.rumble.com/chat/api/chat/{CHAT_ID}/stream`).
